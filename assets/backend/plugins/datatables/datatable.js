    ...
    return {
        ...
        init: function (options) {
            ...
            options = $.extend(true, {
                ...
                dataTable: {
                    "sDom" : "<'row'<'col-md-12'<'table-group-actions mb-2'>>r><'table-responsive't><'row-page'<'col-md-12 py-2'pli>r>>", // datatable layout
                    ...
                    "oLanguage": {                              // language settings
                        "sProcessing":              '<img src="'+ base_url +'ddmassets/backend/img/loading-spinner-blue.gif"/><span>&nbsp;&nbsp;Loading...</span>',
                    ...
                    "sPaginationType":  "theme_full_number",    // pagination type(bootstrap, bootstrap_full_number or bootstrap_extended or theme_full_number)
                        ...
                        oSettings.jqXHR = $.ajax({
                            ...
                            "success": function(res, textStatus, jqXHR) {
                                ...
                                if (tableOptions.onSuccess) {
                                    tableOptions.onSuccess.call(the, res);
                                }
                            ...
                            "error": function() {
                                ...
                                $('.app-alerts', tableWrapper).addClass("mx-4");
            ...
            $('.dataTables_length select', tableWrapper).addClass("form-control form-control-sm");

            // build table group actions panel
            if ($('.table-actions-wrapper', tableContainer).length) {
