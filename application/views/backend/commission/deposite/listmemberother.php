...
<div class="row mb-3">
    ...
    <div class="col-md-6 text-right">                 
        <a href="<?php echo base_url('commission/deposite'); ?>" class="btn btn-sm btn-outline-warning"><i class="fa fa-step-backward"></i> <?php echo lang('back'); ?></a>
    </div>
</div>  
...
<div class="table-container">
    <table class="table align-items-center table-flush" id="list_table_deposite" data-url="<?php echo base_url('commission/memberdepositelistdata/all/'.$member_other_id); ?>">
