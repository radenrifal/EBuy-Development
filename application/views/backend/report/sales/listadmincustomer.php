<table class="table align-items-center table-flush" id="list_table_shop_order" data-url="<?php echo base_url('productorder/customerorderlistsdata'); ?>">
    <thead class="thead-light">
        <tr role="row" class="heading">
            ...
            <th scope="col" class="text-center"><?php echo 'Username Agent' ?></th>
            <th scope="col" class="text-center"><?php echo 'Nama Agent' ?></th>
            <th scope="col" class="text-center"><?php echo 'Nama Master Agent' ?></th>
        ...
        <tr role="row" class="filter" style="background-color: #f6f9fc">
            ...
            <td><input type="text" class="form-control form-control-sm form-filter" name="search_agent_name" /></td>
            <td>
                <div class="mb-1">
