        ...
        <div class="tab-content" id="productListContent">
            ...
            <div class="tab-pane fade show active" id="tabs-history_stock_product" role="tabpanel" aria-labelledby="tabs-history_stock_product-tab">
                <div class="table-container">
                    <table class="table align-items-center table-flush" id="list_report_history_product" data-url="<?php echo base_url('member/historyproductlistdata'); ?>">
                        <thead class="thead-light">
                            <tr role="row" class="heading">
                                <th scope="col" style="width: 10px">#</th>
                                <th scope="col" class="text-center"><?php echo lang('username'); ?></th>
                                <th scope="col" class="text-center"><?php echo 'IN' ?></th>
                                <th scope="col" class="text-center"><?php echo 'OUT'; ?></th>
                                <th scope="col" class="text-center"><?php echo 'Balance'; ?></th>
                            ...
                            <tr role="row" class="filter" style="background-color: #f6f9fc">
                                ...
                                <td>
                                    <div class="mb-1">
                                        <input type="text" class="form-control form-control-sm form-filter text-center numbermask" name="search_in_min" placeholder="Min" />
                                    </div>
                                    <input type="text" class="form-control form-control-sm form-filter text-center numbermask" name="search_in_max" placeholder="Max" />
                                </td>
                                <td>
                                    <div class="mb-1">
                                        <input type="text" class="form-control form-control-sm form-filter text-center numbermask" name="search_out_min" placeholder="Min" />
                                    </div>
                                    <input type="text" class="form-control form-control-sm form-filter text-center numbermask" name="search_out_max" placeholder="Max" />
                                </td>
                                <td>
                                    <div class="mb-1">
                                        <input type="text" class="form-control form-control-sm form-filter text-center numbermask" name="search_balance_min" placeholder="Min" />
                                    </div>
                                    <input type="text" class="form-control form-control-sm form-filter text-center numbermask" name="search_balance_max" placeholder="Max" />
                                </td>
                                <td style="text-align: center;">
                                    <button class="btn btn-sm btn-outline-default btn-tooltip filter-submit" id="btn_list_report_history_product" title="Search"><i class="fa fa-search"></i></button>
            ...
            <div class="tab-pane fade" id="tabs-transfer_product" role="tabpanel" aria-labelledby="tabs-transfer_product-tab">
                <div class="table-container">
                    <table class="table align-items-center table-flush" id="list_report_transfer_product" data-url="<?php echo base_url('member/transferproductlistdata'); ?>">
                        <thead class="thead-light">
                            <tr role="row" class="heading">
                                <th scope="col" style="width: 10px">#</th>
                                <th scope="col" class="text-center"><?php echo lang('date'); ?></th>
                            ...
                            <tr role="row" class="filter" style="background-color: #f6f9fc">
                                ...
                                <td style="text-align: center;">
                                    <button class="btn btn-sm btn-outline-default btn-tooltip filter-submit" id="btn_list_report_transfer_product" title="Search"><i class="fa fa-search"></i></button>
                                    <button class="btn btn-sm btn-outline-warning btn-tooltip filter-cancel" title="Reset"><i class="fa fa-times"></i></button>
                                </td>
                            </tr>
                        </thead>
