...
<section class="content-header">
    <h1><?php echo lang('menu_member_upgrade') ?></h1>
    <ol class="breadcrumb">
        <li><a href="#"><?php echo lang('menu_member'); ?></a></li>
        <li class="active"><?php echo lang('menu_member_upgrade'); ?></li>
    </ol>
</section>
            ...
            <?php else: ?>
                ...
                <div class="box box-primary box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">Form <?php echo lang('menu_member_upgrade'); ?></h3>
                    </div>
                    <form action="<?php echo base_url('member/memberupgrade'); ?>" role="form" method="post" class="form-horizontal" id="upgrade_member_form" data-registrar="<?php echo $member->username ?>" data-access="admin">
                        <div class="box-body upgrade_member_wrapper">
                            ...
                            <div class="form-group top20">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        <input type="text" name="up_member_username" id="up_member_username" class="form-control" placeholder="Username Member" autocomplete="off" value="" />
                                        <span class="input-group-btn">
                                            <button class="btn btn-flat btn-white" type="button" id="btn_search_member_upgrade"><i class="fa fa-search"></i></button>
                                        </span>
                                    </div>
                                </div>
                            </div>

                            <hr><h4 class="form-section top0">Informasi Member</h4><hr class="top0">
                            <!-- Username -->
                            <div class="form-group">
                                <input type="hidden" name="up_member_id" id="up_member_id" class="form-control up_info" />
                            ...
                            <hr><h4 class="form-section top0">Informasi Upgrade</h4><hr class="top0">
                            <!-- Name -->
                            <div class="form-group">
                                <label class="col-md-3 control-label"><?php echo lang('package'); ?> (Upgrade) <span class="required">*</span></label>
                                <div class="col-md-6">
                                    <select class="form-control" name="up_member_package" id="up_member_package">
                        ...
                        <div class="box-footer" style="background: #f5f5f5; padding: 20px 0px">
                            <div class="row">
                                <div class="col-md-offset-3 col-md-9">
                                    ...
                                    <button type="reset" class="btn btn-flat btn-danger btn-upgrade-reset">Reset</button>
                                </div>
                            </div>
                        </div>
                    </form>
